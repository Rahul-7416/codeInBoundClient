...
function WelcomePage() {
  return (
    <div className='h-lvh w-lvw flex justify-center items-center p-5 bg-slate-600'>
      <div className='bg-blue-400 h-[50%] w-[90%] md:h-[50%] md:w-[50%] flex flex-col justify-around rounded-xl px-5 py-0'>
        <div className='flex flex-col gap-6'>
            <h1 className='self-center font-bold text-4xl '>Welcome to CodeInBound</h1>
